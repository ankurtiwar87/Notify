...
class FacultyAdapterOffline(private val context: Context, private val list:List<FacultyEntity>):RecyclerView.Adapter<FacultyAdapterOffline.FacultyViewHolder>(){
